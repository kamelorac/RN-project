...
export default class ProductEdit extends React.Component {
            ...
            .then(user_id => {
                ...
                AsyncStorage.getItem("token")
                    .then(token => {
                        ...
                        this.viewProduct(this.props.product_id, token)
                    })
            })
    ...
    deleteProduct() {
        ...
        fetch(strings.base_Url + 'deleteProduct', {
            ...
            body: JSON.stringify({ "id": this.props.product_id })
        })
            .then((response) => response.json())
            .then((responseData) => {
                                    ...
                                    <View style={{ alignSelf: 'center', width: '90%', flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 30 }}>
                                        <View style={{ justifyContent: 'center', width: '80%', padding: 10 }}>
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 20, width: 150, backgroundColor: 'rgba(0,0,0,0.6)', borderRadius: 50, alignItems: 'center' }}>
                                                ...
                                                <Text style={[styles.font_regu, { fontSize: 16, color: colors.testColorWhite, alignSelf: 'center' }]}>{this.state.currency}</Text>
                                            </View>
