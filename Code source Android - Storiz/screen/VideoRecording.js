...
import {
    StyleSheet, StatusBar, ActivityIndicator, FlatList, TextInput, ImageBackground, Dimensions, TouchableOpacity, SafeAreaView, View, Text, Image
} from 'react-native';
...
export default class VideoRecording extends React.Component {
   ...
   async cpmpress(){
    console.log("result this.props.videoUrl  metaData :$$%%%%%:::" + this.props.videoUrl)
    const metaData = await getVideoMetaData(this.props.videoUrl);
        ...
        return (
            <SafeAreaView style={{ flex: 1, alignItems: 'center', backgroundColor: colors.testColorWhite }}>
                <ImageBackground style={{ width: '100%', height: '100%', }}
                    ...
                    <Videos source={{ uri: data_url == ''?  '' : this.props.videoUrl }}   // Can be a URL or a local file.
                        ref={(ref) => {
                            this.player = ref
                        }}
                      //  maxBitRate={2000000}
                    ...
                    <View style={{ justifyContent: 'space-between', flex: 1 }}>
                        ...
                        <View>
                            {this.state.priceView === false ?
                                ...
                                <View style={{ alignSelf: 'center', width: '90%', marginBottom: 30, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                    <View style={{ height: 40, width: '50%', backgroundColor: 'rgba(0,0,0,0.6)', borderRadius: 50, }}>
                                        <TextInput
