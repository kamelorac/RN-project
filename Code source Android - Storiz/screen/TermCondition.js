    ...
    render() {
        return (
            <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
                <TouchableOpacity onPress={() => Actions.pop()} style={{ marginLeft: 10, alignItems: 'center', width: 45, height: 45, justifyContent: 'center', marginTop: 10, marginBottom: 20 }}>
