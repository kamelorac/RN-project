...
export default class WebVideoPlay extends React.Component {
    ...
    componentDidMount() {
      ...
      //  vidoe_file_2 = this.props.videoUrl
            ...
            .then((responseData) => {
                ...
                if (responseData.status === true) {
                    this.setState({
                        ...
                        save_or_not: responseData.user.savedProducts.includes(this.props.product_id)
                    })
       ...
       //file:///data/user/0/com.storiz.app/cache/Camera/7312c3e9-b544-4a99-91f5-8730e730ae05.mp4
        return (
            <KeyboardAvoidingView behavior='position' style={{ backgroundColor: 'white', flex: 1 }}>
                <ImageBackground
                    source={{ uri: this.props.posterImage }}
                    ...
                    <View style={{ alignItems: 'center', justifyContent: 'center', position: 'absolute', width: '100%', height: '100%', backgroundColor: "transparent", bottom: 0 }}>
                        <TouchableOpacity onPress={() => Actions.push("Home", { type_index: 1 })} style={{ alignSelf: 'flex-start', marginLeft: 20, width: 40, height: 40, alignItems: 'center', justifyContent: 'center', marginTop: 10 }}>
                        ...
                        <View style={{ width: '100%', alignSelf: 'center', justifyContent: 'space-between', flex: 1 }}>
                            <View>
                                <View style={{ alignSelf: 'center', width: '90%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                    <TouchableOpacity onPress={() => Actions.push("SeeUserProfile", { other_user_id: this.state.other_user_id })} style={{ width: '50%', flexDirection: 'row', alignItems: 'center', }}>
