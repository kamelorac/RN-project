        ...
        return (
            <SafeAreaView style={{ flex: 1, alignItems: 'center', backgroundColor: colors.themeColor }}>
                ...
                <View style={{width:'100%', height: '100%', justifyContent: 'space-between', flexDirection: 'column', }}>
                    ...
                    <TouchableOpacity onPress={()=>  Actions.push("Login")} style={{width:'90%',height:55,backgroundColor:'#fff',borderRadius:20,marginBottom:20,alignItems:'center',justifyContent:'center'}}>
                        <Text style={{ fontSize: 14, color: '#000',fontFamily:'CamptonMedium',fontWeight:'bold'}}>Se connecter</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={()=>Actions.push("Register")} style={{width:'90%',height:55,borderWidth:1,borderColor:'#fff',borderRadius:20,marginBottom:100,alignItems:'center',justifyContent:'center'}}>
                        <Text style={{ fontSize: 14, color: '#fff',fontFamily:'CamptonMedium',fontWeight:'bold'}}>S'inscrire</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </SafeAreaView>
