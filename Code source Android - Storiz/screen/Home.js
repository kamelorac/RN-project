...
export default class Home extends React.Component {
    ...
    start = () => {
        ...
        this.videoRecorder.open({ maxLength: 30 }, (data) => {
            ...
            Actions.push("VideoRecording", { videoUrl: data.uri })
        });
            ...
            >
                <SafeAreaView style={{ flex: 1, alignItems: 'center', backgroundColor: colors.testColorWhite }}>
                    ...
                    <View style={{ width: '90%', height: 60, alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <TouchableOpacity onPress={()=> Actions.push("Profile")} style={{ width: 45, height: 45, justifyContent: 'center', alignItems: 'flex-end', }}>
                    ...
                    <View style={{ position: 'absolute', bottom: 0, height: 70, width: '100%', alignItems: 'center', backgroundColor: colors.themeColor }}>
