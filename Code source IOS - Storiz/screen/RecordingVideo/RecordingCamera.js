...
export default class VideoRecorder extends Component {
  ...
  onSave = () => {
    ...
    this.props.navigation.navigate("VideoRecording", { videoUrl: this.state.recordedData.uri })
  ...
  onSwipe(gestureName, gestureState) {
    ...
    switch (gestureName) {
      case SWIPE_RIGHT:
        this.props.navigation.navigate("Tabs",{type_index:1})
        break;
    }
  }
  render() {
          ...
          <TouchableWithoutFeedback onPress={()=> this.onPress2()} style={{ flex: 1 }}>
            <View style={[styles.modal, { marginBottom: 100 }]}>
              ...
              <View style={styles.container}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', top: 50, position: 'absolute', width: '90%' }}>
