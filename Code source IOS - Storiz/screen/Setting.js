...
import {
    StyleSheet,Alert,ActivityIndicator, StatusBar, TouchableOpacity, SafeAreaView,Linking, View, Text, Image, Modal, FlatList
} from 'react-native';
...
export default class Setting extends React.Component {
    ...
    deleteAlert() {
        Alert.alert(
            "Storiz",
            'Vous êtes sûr de vouloir vous supprimer compte',
            [
                {
                    text: 'Oui',
    ...
    delete_account() {
        ...
        fetch(strings.base_Url + 'delete-account', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
            ...
            .then((response) => response.json())
            .then((responseData) => {
                console.log("messages::delete-account: $$$$$:" + JSON.stringify(responseData));
            ...
            <SafeAreaView style={{ flex: 1, alignItems: 'center', backgroundColor: colors.testColorWhite }}>
                ...
                <ScrollView style={{ width: '100%' }}>
                    <View style={{ width: '100%', alignItems: 'center',marginBottom:50 }}>
                        ...
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate("PersonalInfo")} style={{marginTop:80, flexDirection: 'row', alignItems: 'center', width: '85%', height: 75, backgroundColor: 'rgba(180,180,180,0.1)', borderRadius: 20 }}>
                        ...
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate("BlockProfile")} style={{marginTop:50, flexDirection: 'row', alignItems: 'center', width: '85%', height: 75, backgroundColor: 'rgba(180,180,180,0.1)', borderRadius: 20 }}>
                            <Image style={{ width: 20, height: 20, resizeMode: 'contain', marginLeft: 40 }} source={require('../assets/block.png')} />
                            <Text style={[styles.font_regu, { fontSize: 16, color: colors.textColorBlack, marginLeft: 20 }]}>
                                {'Profils bloqués'}
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate("Contactus")} style={{marginTop:50, flexDirection: 'row', alignItems: 'center', width: '85%', height: 75, backgroundColor: 'rgba(180,180,180,0.1)', borderRadius: 20 }}>
                        ...
                        <TouchableOpacity onPress={()=>
                            ...
                            this.props.navigation.navigate("TermCondition",{link_data:'terms'})
                        ...
                        <TouchableOpacity onPress={()=>
                            //Linking.openURL('https://www.portal.storiz.eu/terms')
                            this.props.navigation.navigate("TermCondition",{link_data:'privacy'})
                        ...
                        <TouchableOpacity onPress={()=>this.deleteAlert()} style={{marginTop:50, flexDirection: 'row', alignItems: 'center', width: '85%', height: 75, backgroundColor: 'rgba(180,180,180,0.1)', borderRadius: 20 }}>
                            <Image style={{ width: 20, height: 20, resizeMode: 'contain', marginLeft: 40 }} source={require('../assets/3.png')} />
                            <Text style={[styles.font_regu, { fontSize: 16, color: colors.textColorBlack, marginLeft: 20 }]}>
