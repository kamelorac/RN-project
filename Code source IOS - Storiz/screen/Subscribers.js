                                ...
                                <View style={{ width: '98%', alignSelf: 'center', marginTop: 0 }}>
                                    <FlatList
                                        ...
                                        renderItem={({ item, index }) => {
                                            ...
                                            return (
                                                <TouchableOpacity onPress={() => this.props.navigation.navigate("SeeUserProfile", { other_user_id: item._id })+this.removeNewSubscriber()} style={{ width: '100%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 20 }}>
