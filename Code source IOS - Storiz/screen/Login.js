    ...
    async requestLocationPermission() {
        try {
            const granted = await PermissionsAndroid.requestMultiple([
                PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION , PermissionsAndroid.PERMISSIONS.CAMERA , PermissionsAndroid.PERMISSIONS.RECORD_AUDIO])
    ...
    render() {
        return (
            <SafeAreaView style={{ flex: 1, alignItems: 'center', backgroundColor: colors.testColorWhite }}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate("SignUp")} style={{marginLeft:10,alignItems:'center', width: 45, height: 45, justifyContent: 'center', marginTop: 20 }}>
                    ...
                    <View style={{ width: '85%', flexDirection: 'column', alignSelf: 'center' }}>
                        ...
                        <View style={[styles.input_view, { marginTop: 100 }]}>
                            <TextInput style={[
                                //styles.font_regu,
                            { fontSize: 16, color: colors.textColorBlack }]}
                        ...
                        <View style={[styles.input_view, { marginTop: 30, flexDirection: 'row', justifyContent: 'space-between' }]}>
                            <TextInput style={[
                                //styles.font_regu,
                            {width:'80%', fontSize: 16, color: colors.textColorBlack }]}
                        ...
                        {!!this.state.passwordErr && (
                            <Text style={[
                                styles.font_regu, 
                                { width: '80%', fontSize: 14, color: '#F15D26', marginTop: 10 }]}>{this.state.passwordErr}</Text>
                        )}
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate("ForgotPassword")} style={{ alignSelf: 'center', padding: 20 }}>
