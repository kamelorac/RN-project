                        ...
                        <View style={{ width: '90%', flexDirection: 'column', alignSelf: 'center', marginBottom: 80 }}>
                            <FlatList
                                ...
                                renderItem={({ item, index }) => {
                                    ...
                                    return (
                                        <TouchableOpacity onPress={() => this.props.navigation.navigate("Chat", { room_id: item.roomId, receiver_name: item.roomName, receiver_profile: item.profile, receiver_id: item.OtherId, roomDetails: item })} style={[styles.input_view, { justifyContent: 'space-between', flexDirection: 'row', width: '95%', height: 70, alignItems: 'center',
                                            ...
                                            <View style={{ width: '80%', flexDirection: 'row', alignItems: 'center' }}>
                                                <View style={{ width: 80, height: 70, alignItems: 'center', justifyContent: 'center' }}>
                                                    <Image style={{ width: 50, height: 50, borderRadius: 50 }} source={profiles} />
                                                </View>
                                                <View>
